"""
Django settings for telegramchannels project.
...
SECRET_KEY = 'django-insecure-7rcugl$(7cd5xi_7$v(s*83ph3mlo!kqbxp(oj+act364*%i!q'
...
ROOT_URLCONF = 'telegramchannels.urls'
...
WSGI_APPLICATION = 'telegramchannels.wsgi.application'
